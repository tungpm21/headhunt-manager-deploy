...
| `page.tsx` | 3.6KB | `src/app/(dashboard)/candidates/[id]/page.tsx` |
| `page.tsx` | 1.2KB | `src/app/(dashboard)/candidates/new/page.tsx` |
| `page.tsx` | 3.0KB | `src/app/(dashboard)/candidates/page.tsx` |
| `page.tsx` | 7.0KB | `src/app/(dashboard)/clients/[id]/page.tsx` |
| `page.tsx` | 1.3KB | `src/app/(dashboard)/clients/new/page.tsx` |
| `page.tsx` | 2.1KB | `src/app/(dashboard)/clients/page.tsx` |
| `page.tsx` | 24.0KB | `src/app/(dashboard)/dashboard/page.tsx` |
| `page.tsx` | 3.6KB | `src/app/(dashboard)/employers/[id]/edit/page.tsx` |
| `page.tsx` | 8.0KB | `src/app/(dashboard)/employers/[id]/page.tsx` |
| `page.tsx` | 8.1KB | `src/app/(dashboard)/employers/page.tsx` |
| `page.tsx` | 1.8KB | `src/app/(dashboard)/import/page.tsx` |
| `page.tsx` | 2.9KB | `src/app/(dashboard)/jobs/[id]/page.tsx` |
| `page.tsx` | 1.5KB | `src/app/(dashboard)/jobs/new/page.tsx` |
| `page.tsx` | 2.0KB | `src/app/(dashboard)/jobs/page.tsx` |
| `layout.tsx` | 2.3KB | `src/app/(dashboard)/layout.tsx` |
| `page.tsx` | 2.9KB | `src/app/(dashboard)/moderation/applications/page.tsx` |
| `page.tsx` | 7.9KB | `src/app/(dashboard)/moderation/page.tsx` |
...
| `page.tsx` | 11.4KB | `src/app/(public)/viec-lam/[slug]/page.tsx` |
...
| `bulk-action-bar.tsx` | 3.8KB | `src/components/candidates/bulk-action-bar.tsx` |
| `bulk-assign-modal.tsx` | 6.4KB | `src/components/candidates/bulk-assign-modal.tsx` |
| `bulk-tag-modal.tsx` | 4.4KB | `src/components/candidates/bulk-tag-modal.tsx` |
| `candidate-detail-tabs.tsx` | 2.4KB | `src/components/candidates/candidate-detail-tabs.tsx` |
| `candidate-filters.tsx` | 11.2KB | `src/components/candidates/candidate-filters.tsx` |
| `candidate-form.tsx` | 18.1KB | `src/components/candidates/candidate-form.tsx` |
...
| `candidate-pipelines.tsx` | 4.2KB | `src/components/candidates/candidate-pipelines.tsx` |
| `candidate-quick-view.tsx` | 5.5KB | `src/components/candidates/candidate-quick-view.tsx` |
| `candidate-reminders.tsx` | 9.2KB | `src/components/candidates/candidate-reminders.tsx` |
| `candidate-table-wrapper.tsx` | 1.9KB | `src/components/candidates/candidate-table-wrapper.tsx` |
| `candidate-table.tsx` | 14.4KB | `src/components/candidates/candidate-table.tsx` |
...
| `activity-feed.tsx` | 2.7KB | `src/components/dashboard/activity-feed.tsx` |
| `deadline-alerts.tsx` | 4.2KB | `src/components/dashboard/deadline-alerts.tsx` |
| `follow-up-reminders.tsx` | 4.8KB | `src/components/dashboard/follow-up-reminders.tsx` |
| `pipeline-summary.tsx` | 4.2KB | `src/components/dashboard/pipeline-summary.tsx` |
...
| `global-search-trigger.tsx` | 637B | `src/components/global-search-trigger.tsx` |
| `global-search.tsx` | 7.6KB | `src/components/global-search.tsx` |
| `spreadsheet-importer.tsx` | 10.6KB | `src/components/import/spreadsheet-importer.tsx` |
| `index.ts` | 173B | `src/components/index.ts` |
| `assign-candidate-modal.tsx` | 13.1KB | `src/components/jobs/assign-candidate-modal.tsx` |
| `email-template-modal.tsx` | 4.3KB | `src/components/jobs/email-template-modal.tsx` |
| `job-filters.tsx` | 4.7KB | `src/components/jobs/job-filters.tsx` |
| `job-form.tsx` | 11.7KB | `src/components/jobs/job-form.tsx` |
| `job-info-card.tsx` | 7.6KB | `src/components/jobs/job-info-card.tsx` |
| `job-pipeline.tsx` | 15.5KB | `src/components/jobs/job-pipeline.tsx` |
| `job-table.tsx` | 5.4KB | `src/components/jobs/job-table.tsx` |
| `pipeline-detail-panel.tsx` | 4.0KB | `src/components/jobs/pipeline-detail-panel.tsx` |
| `pipeline-kanban.tsx` | 8.0KB | `src/components/jobs/pipeline-kanban.tsx` |
| `pipeline-view-switcher.tsx` | 7.7KB | `src/components/jobs/pipeline-view-switcher.tsx` |
| `login-form.tsx` | 2.1KB | `src/components/login-form.tsx` |
| `mobile-sidebar.tsx` | 1.7KB | `src/components/mobile-sidebar.tsx` |
| `notification-bell.tsx` | 4.3KB | `src/components/notification-bell.tsx` |
...
| `sidebar.tsx` | 5.2KB | `src/components/sidebar.tsx` |
| `theme-toggle.tsx` | 1.1KB | `src/components/theme-toggle.tsx` |
...
| File | Size | Path |
|------|------|------|
| `candidate-actions.ts` | 3.4KB | `src/lib/candidate-actions.ts` |
| `candidate-detail-actions.ts` | 8.7KB | `src/lib/candidate-detail-actions.ts` |
| `client-actions.ts` | 4.6KB | `src/lib/client-actions.ts` |
| `employer-actions.ts` | 14.6KB | `src/lib/employer-actions.ts` |
| `import-actions.ts` | 4.8KB | `src/lib/import-actions.ts` |
| `job-actions.ts` | 9.7KB | `src/lib/job-actions.ts` |
| `moderation-actions.ts` | 19.0KB | `src/lib/moderation-actions.ts` |
| `public-actions.ts` | 15.1KB | `src/lib/public-actions.ts` |
...
| File | Size | Path |
|------|------|------|
| `actions.ts` | 13.7KB | `src/lib/actions.ts` |
| `activity-log.ts` | 492B | `src/lib/activity-log.ts` |
| `authz.ts` | 505B | `src/lib/authz.ts` |
| `candidate-cv.ts` | 3.0KB | `src/lib/candidate-cv.ts` |
| `candidate-export.ts` | 1.1KB | `src/lib/candidate-export.ts` |
| `candidate-language.ts` | 1.0KB | `src/lib/candidate-language.ts` |
| `candidates.ts` | 8.2KB | `src/lib/candidates.ts` |
| `clients.ts` | 4.2KB | `src/lib/clients.ts` |
| `email-templates.ts` | 3.6KB | `src/lib/email-templates.ts` |
| `employer-auth.ts` | 1.9KB | `src/lib/employer-auth.ts` |
| `employer-jwt.ts` | 318B | `src/lib/employer-jwt.ts` |
| `global-search.ts` | 3.5KB | `src/lib/global-search.ts` |
| `job-pipeline.ts` | 2.8KB | `src/lib/job-pipeline.ts` |
| `jobs.ts` | 4.2KB | `src/lib/jobs.ts` |
| `notifications.ts` | 1.2KB | `src/lib/notifications.ts` |
| `prisma.ts` | 651B | `src/lib/prisma.ts` |
| `rate-limit.ts` | 2.2KB | `src/lib/rate-limit.ts` |
| `reminders.ts` | 2.2KB | `src/lib/reminders.ts` |
| `revenue.ts` | 6.7KB | `src/lib/revenue.ts` |
| `storage.ts` | 1.7KB | `src/lib/storage.ts` |
| `tags.ts` | 972B | `src/lib/tags.ts` |
| `utils.ts` | 1.6KB | `src/lib/utils.ts` |
| `auth-helpers.ts` | 188B | `src/lib/utils/auth-helpers.ts` |
| `form-helpers.ts` | 904B | `src/lib/utils/form-helpers.ts` |
...
| File | Size | Path |
|------|------|------|
| `candidate.ts` | 3.8KB | `src/types/candidate.ts` |
| `client.ts` | 1005B | `src/types/client.ts` |
| `index.ts` | 2.9KB | `src/types/index.ts` |
| `job.ts` | 1.9KB | `src/types/job.ts` |
...
| `employer-edit-form.tsx` | 14.6KB | `src/app/(dashboard)/employers/[id]/edit/employer-edit-form.tsx` |
| `employer-detail-tabs.tsx` | 20.6KB | `src/app/(dashboard)/employers/[id]/employer-detail-tabs.tsx` |
| `employer-status-actions.tsx` | 1.7KB | `src/app/(dashboard)/employers/employer-status-actions.tsx` |
| `link-employer-form.tsx` | 3.2KB | `src/app/(dashboard)/employers/link-employer-form.tsx` |
| `application-table.tsx` | 19.4KB | `src/app/(dashboard)/moderation/applications/application-table.tsx` |
...
## 📊 Summary: 180 total source files
