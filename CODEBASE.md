...
| `page.tsx` | 3.8KB | `src/app/(dashboard)/candidates/[id]/page.tsx` |
...
| `page.tsx` | 1.7KB | `src/app/(dashboard)/import/page.tsx` |
...
| `candidate-filters.tsx` | 10.1KB | `src/components/candidates/candidate-filters.tsx` |
...
| `excel-importer.tsx` | 7.8KB | `src/components/import/excel-importer.tsx` |
...
| `ApplyForm.tsx` | 8.3KB | `src/components/public/ApplyForm.tsx` |
...
| `sidebar.tsx` | 4.0KB | `src/components/sidebar.tsx` |
...
| `employer-actions.ts` | 13.8KB | `src/lib/employer-actions.ts` |
| `import-actions.ts` | 2.0KB | `src/lib/import-actions.ts` |
| `job-actions.ts` | 7.5KB | `src/lib/job-actions.ts` |
| `moderation-actions.ts` | 10.3KB | `src/lib/moderation-actions.ts` |
...
| File | Size | Path |
|------|------|------|
| `actions.ts` | 10.0KB | `src/lib/actions.ts` |
| `candidates.ts` | 6.1KB | `src/lib/candidates.ts` |
| `clients.ts` | 4.2KB | `src/lib/clients.ts` |
| `employer-auth.ts` | 2.1KB | `src/lib/employer-auth.ts` |
...
| File | Size | Path |
|------|------|------|
| `candidate.ts` | 2.4KB | `src/types/candidate.ts` |
...
| `route.ts` | 1.3KB | `src/app/api/public/apply-cv/route.ts` |

## Config (3 files)

| File | Size | Path |
|------|------|------|
| `auth.config.ts` | 1.4KB | `src/auth.config.ts` |
| `auth.ts` | 1.3KB | `src/auth.ts` |
| `proxy.ts` | 2.1KB | `src/proxy.ts` |
...
## 📊 Summary: 131 total source files
