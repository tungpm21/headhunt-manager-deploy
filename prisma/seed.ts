  ...
  await prisma.jobPosting.createMany({
    data: [
      // Samsung (5 jobs)
      {
        ...
        industrialZone: "KCN Yên Phong, Bắc Ninh", requiredLanguages: ["Korean"], languageProficiency: "Trung cấp (N3 / TOPIK 2)", shiftType: "ROTATING"
      },

      {
        ...
        industrialZone: "KCN Yên Phong, Bắc Ninh", requiredLanguages: ["Korean"], languageProficiency: "Trung cấp (N3 / TOPIK 2)", shiftType: "DAY"
      },

      {
        ...
        industrialZone: "KCN Yên Phong, Bắc Ninh", requiredLanguages: [], languageProficiency: null, shiftType: "ROTATING"
      },

      {
        ...
        industrialZone: "KCN Yên Phong, Bắc Ninh", requiredLanguages: ["English"], languageProficiency: "Cơ bản (N4 / TOPIK 1)", shiftType: "DAY"
      },

      {
        ...
        industrialZone: "KCN Yên Phong, Bắc Ninh", requiredLanguages: ["Korean"], languageProficiency: "Thành thạo (N1 / TOPIK 4+)", shiftType: "DAY"
      },
      ...
      // Canon (3 jobs)
      {
        ...
        industrialZone: "KCN Quế Võ, Bắc Ninh", requiredLanguages: ["Japanese"], languageProficiency: "Trung cấp (N3 / TOPIK 2)", shiftType: "DAY"
      },

      {
        ...
        industrialZone: "KCN Quế Võ, Bắc Ninh", requiredLanguages: ["Japanese"], languageProficiency: "Khá (N2 / TOPIK 3)", shiftType: "DAY"
      },

      {
        ...
        industrialZone: "KCN Quế Võ, Bắc Ninh", requiredLanguages: ["Japanese"], languageProficiency: "Cơ bản (N4 / TOPIK 1)", shiftType: "ROTATING"
      },
      ...
      // Toyota (3 jobs)
      {
        ...
        industrialZone: "KCN Quang Minh, Vĩnh Phúc", requiredLanguages: ["Japanese"], languageProficiency: "Trung cấp (N3 / TOPIK 2)", shiftType: "DAY"
      },

      {
        ...
        industrialZone: null, requiredLanguages: ["English"], languageProficiency: "Khá (N2 / TOPIK 3)", shiftType: "DAY"
      },

      {
        ...
        industrialZone: "KCN Quang Minh, Vĩnh Phúc", requiredLanguages: [], languageProficiency: null, shiftType: "ROTATING"
      },
      ...
      // LG (3 jobs)
      {
        ...
        industrialZone: "KCN Tràng Duệ, Hải Phòng", requiredLanguages: ["English"], languageProficiency: "Cơ bản (N4 / TOPIK 1)", shiftType: "DAY"
      },
...

      {
        ...
        industrialZone: "KCN Tràng Duệ, Hải Phòng", requiredLanguages: ["Korean"], languageProficiency: "Khá (N2 / TOPIK 3)", shiftType: "DAY"
      },
      ...
      // Bosch (2 jobs)
      {
        ...
        industrialZone: "Quận 7 / Tân Phú, TP.HCM", requiredLanguages: ["English"], languageProficiency: "Khá (N2 / TOPIK 3)", shiftType: "DAY"
      },

      {
        ...
        industrialZone: null, requiredLanguages: ["English"], languageProficiency: "Cơ bản (N4 / TOPIK 1)", shiftType: "DAY"
      },
      ...
      // Nestlé (2 jobs)
      {
        ...
        industrialZone: null, requiredLanguages: ["English"], languageProficiency: "Thành thạo (N1 / TOPIK 4+)", shiftType: "DAY"
      },

      {
        ...
        industrialZone: "KCN Amata, Đồng Nai", requiredLanguages: ["English"], languageProficiency: "Cơ bản (N4 / TOPIK 1)", shiftType: "DAY"
      },
      ...
      // Panasonic (2 jobs)
      {
        ...
        industrialZone: "KCN Thăng Long, Hà Nội", requiredLanguages: ["Japanese"], languageProficiency: "Trung cấp (N3 / TOPIK 2)", shiftType: "DAY"
      },

      {
        ...
        industrialZone: "KCN Thăng Long, Hà Nội", requiredLanguages: ["Japanese"], languageProficiency: "Cơ bản (N4 / TOPIK 1)", shiftType: "DAY"
      },
    ].map((job) => ({
      ...job,
      skills: job.skills
