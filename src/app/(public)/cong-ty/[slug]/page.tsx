      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-4">
        <div className="relative h-72 sm:h-80 lg:h-96 rounded-2xl overflow-hidden shadow-lg">
          {company.coverImage ? (
            ...
            <div className="w-full h-full bg-gradient-to-r from-[var(--color-fdi-dark)] via-[var(--color-fdi-navy-mid)] to-[var(--color-fdi-primary)]" />
          )}
          {company.coverImage && (
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-6">
            ...
            {company.jobPostings.length === 0 && !company.description && (
              <div className="bg-white rounded-xl border border-[var(--color-fdi-mist)] p-8 text-center text-[var(--color-fdi-text-secondary)]">
          ...
          <div className="lg:w-80 shrink-0">
            <div className="lg:sticky lg:top-24 bg-white rounded-xl border border-[var(--color-fdi-mist)] p-6 space-y-4">
              ...
              <dl className="space-y-3 text-sm text-[var(--color-fdi-text-secondary)]">
                {infoItems.map(
                  (item) =>
                    item.value && (
                      <div key={item.label} className="flex items-start gap-2.5">
                        <item.icon className="h-4 w-4 text-[var(--color-fdi-primary)] shrink-0 mt-0.5" aria-hidden="true" />
                        <div>
                          <dt className="text-xs text-[var(--color-fdi-text-secondary)] uppercase tracking-wider mb-0.5">
                            {item.label}
                          </dt>
                          {item.isLink ? (
                            <dd>
