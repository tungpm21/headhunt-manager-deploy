...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-visible">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-1 pt-5 sm:px-6 sm:pt-6 lg:px-8 lg:pt-6">
        <div
        ...
        >
          ...
          <form
            ...
            className="flex flex-col items-stretch gap-1 rounded-[16px] border border-[rgba(15,78,120,0.10)] bg-[var(--color-fdi-paper)] p-1 shadow-[0_16px_42px_-30px_rgba(15,78,120,0.22),inset_0_1px_1px_rgba(255,255,255,0.95)] transition-[border-color,box-shadow] duration-300 ease-[var(--ease-fdi)] focus-within:border-[var(--color-fdi-primary)]/70 focus-within:shadow-[0_20px_52px_-32px_rgba(15,78,120,0.30),inset_0_1px_1px_rgba(255,255,255,0.95)] sm:min-h-[50px] sm:flex-row sm:items-center"
          >
            {/* Keyword input */}
            <div className="flex min-h-11 flex-1 items-center gap-2 px-3 sm:min-h-10 sm:px-4">
              ...
              <input
                ...
                style={{ outline: "none" }}
                className="min-h-11 flex-1 bg-transparent text-sm text-[var(--color-fdi-text)] outline-none placeholder:text-[#8A98A8] focus:outline-none focus:ring-0 focus-visible:outline-none sm:min-h-10 sm:text-base"
                autoComplete="off"
              />
            </div>
            ...
            <div className="flex shrink-0 items-center gap-2 px-1 sm:px-0">
              ...
              <div ref={locationRef} className="relative">
                <button
                  ...
                  className="inline-flex min-h-11 max-w-[156px] items-center gap-2 rounded-lg bg-[#F2F6F9] px-3 text-sm font-semibold text-[var(--color-fdi-text)] transition-colors hover:bg-[#E7F0F6] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-fdi-primary)]/30 sm:min-h-10 sm:max-w-[190px]"
                >
              ...
              <button
                ...
                className="group inline-flex min-h-11 shrink-0 items-center gap-2 rounded-lg border border-[var(--color-fdi-primary)] bg-[var(--color-fdi-primary)] py-1 pl-4 pr-1 text-sm font-bold text-white shadow-[0_12px_26px_-20px_rgba(10,111,157,0.9)] transition-[background-color,border-color,box-shadow,transform] duration-300 ease-[var(--ease-fdi)] hover:-translate-y-0.5 hover:border-[var(--color-fdi-primary-hover)] hover:bg-[var(--color-fdi-primary-hover)] hover:shadow-[0_16px_30px_-20px_rgba(10,111,157,0.92)] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-fdi-primary)]/35 cursor-pointer sm:mr-1 sm:min-h-10"
              >
                Tìm kiếm
                <span className="flex h-8 w-8 items-center justify-center rounded-md bg-white/18 transition-transform duration-300 ease-[var(--ease-fdi)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 sm:h-7 sm:w-7">
